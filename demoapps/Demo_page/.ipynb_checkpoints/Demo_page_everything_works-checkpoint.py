...
def update_selected_datasets(splits, classifiers, max_len_coef_DFT, max_len_coef_DWT):
    ...
    return max_DFT, max_DWT, t_acc, t_comp, f'The Dataset Name that we run the models on is: \"{selected_dataset}\"'
